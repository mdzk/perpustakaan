...
<body>
    <section id="home" class="h-100 w-100" style="box-sizing: border-box; background-color: #fff">
        <div class="container-xxl mx-auto p-0  position-relative header-2-3" style="font-family: 'Poppins', sans-serif;">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a href="<?= base_url(); ?>">
                    <img style="margin-right:0.75rem" src="<?= base_url('/assets/images/logo/favicon.png'); ?>" height="40px" alt="">
                </a>
    ...
    <section id="kontak" class="h-100 w-100" style="box-sizing: border-box; background-color: #fff">
            ...
            <div class="list-footer">
                <div class="row gap-md-0 gap-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <h2 class="footer-text-title">Navigasi</h2>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <h2 class="footer-text-title">Kontak kami</h2>
                        <nav class="list-unstyled">
                            <li class="list-space">
                                <a class="list-menu">
            ...
            <div class="border-color info-footer">
                ...
                <div class="mx-auto d-flex flex-column flex-lg-row align-items-center footer-info-space gap-4">
                    ...
                    <nav class="d-flex flex-lg-row flex-column align-items-center justify-content-center">
                        <p style="margin: 0">Copyright © 2022 Perpustakaan Jurusan</p>
                    </nav>
                </div>
            </div>
        </div>
